<?php
/**
 * The template for displaying the content of Status post entries on search/archive pages.
...
<?php if ( $shootingstar_featured_image_size != 'Small' && has_post_thumbnail() ) { ?>
...
<?php } ?>
          <div class="post-entry-content">
            <p class="content-status"><i class="icon_quotations" aria-hidden="true"></i> <?php shootingstar_status_content(); ?> <i class="icon_quotations" aria-hidden="true"></i></p>
          </div>
        </div>
