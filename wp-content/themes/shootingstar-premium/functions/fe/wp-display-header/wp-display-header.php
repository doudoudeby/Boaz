...
if ( ! class_exists( 'shootingstar_Wp_Plugins_v301' ) )
	require_once( 'wp-display-header-functions.php' );


register_activation_hook( __FILE__, array(
	'shootingstar_Wp_Display_Header',
	'activation'
) );


class shootingstar_Wp_Display_Header extends shootingstar_Wp_Plugins_v301 {
	 ...
	 * @access public
	 *
	 * @return shootingstar_Wp_Display_Header
	 */
...
} // End of class shootingstar_Wp_Display_Header.
 ...
 * @return void
 */
function shootingstar_wpdh_instantiate() {

	if ( current_theme_supports( 'custom-header' ) )
		new shootingstar_Wp_Display_Header;
}
add_action( 'init', 'shootingstar_wpdh_instantiate', 1 );
