...
class shootingstar_Wp_Plugins_v301 {
	 ...
	 *
	 * @return shootingstar_Wp_Plugins
	 */
	public function __construct( $args = array() ) {
		...
		load_plugin_textdomain( 'shootingstar-wp', false, $this->textdomain . '/lang' );
	...
	public function parent_plugins_loaded() {
		...
		if ( ! has_action( 'shootingstar_side_info_column' ) ) {
			$this->hook( 'shootingstar_side_info_column', 'feed_box'      );
		}
	}
...
} // End of class shootingstar_Wp_Plugins
