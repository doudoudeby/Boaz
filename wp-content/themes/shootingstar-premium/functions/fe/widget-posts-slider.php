<?php
/**
 * Plugin Name: ShootingStar Posts-Slider Widget
 * Description: Displays the latest posts from the selected category as a slider.
 * Author: Tomas Toman	
 * Version: 1.0
*/

add_action('widgets_init', create_function('', 'return register_widget("shootingstar_homepage_slider");'));
class shootingstar_homepage_slider extends WP_Widget {
	function __construct() {
		$widget_ops = array('classname' => 'homepage-slider-posts', 'description' => __('Displays the latest posts from the selected category as a slider.', 'shootingstar') );
		$control_ops = array('width' => 200, 'height' => 400);
		parent::__construct('shootingstarslider', __('ShootingStar Posts-Slider', 'shootingstar'), $widget_ops, $control_ops);
	}
