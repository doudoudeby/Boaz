...
class brickyard_widget extends WP_Widget {
	function __construct() {
		...
		parent::__construct('brickyard_widget', __('BrickYard Tab Widget', 'brickyard'), $widget_ops, $control_ops);
    }	
...
add_action('widgets_init', 'brickyard_unregister_mts_tabs_widget', 100);
function brickyard_unregister_mts_tabs_widget() {
