...
// Google Fonts
$bodyfont = get_theme_mod('brickyard_body_google_fonts', get_option('brickyard_body_google_fonts', 'default'));
$headingfont = get_theme_mod('brickyard_headings_google_fonts', get_option('brickyard_headings_google_fonts', 'default'));
$descriptionfont = get_theme_mod('brickyard_description_google_fonts', get_option('brickyard_description_google_fonts', 'default'));
$headlinefont = get_theme_mod('brickyard_headline_google_fonts', get_option('brickyard_headline_google_fonts', 'default'));
$headlineboxfont = get_theme_mod('brickyard_headline_box_google_fonts', get_option('brickyard_headline_box_google_fonts', 'default'));
$postentryfont = get_theme_mod('brickyard_postentry_google_fonts', get_option('brickyard_postentry_google_fonts', 'default'));
$sidebarfont = get_theme_mod('brickyard_sidebar_google_fonts', get_option('brickyard_sidebar_google_fonts', 'default'));
$menufont = get_theme_mod('brickyard_menu_google_fonts', get_option('brickyard_menu_google_fonts', 'default'));
$topmenufont = get_theme_mod('brickyard_top_menu_google_fonts', get_option('brickyard_top_menu_google_fonts', 'default'));

$fonturl = "//fonts.googleapis.com/css?family=";
$character_set = "&amp;subset=" . get_theme_mod('brickyard_character_set', get_option('brickyard_character_set', 'latin'));
...
function brickyard_get_social_icons_background_color() {
    $social_icons_background_color = get_theme_mod('brickyard_social_icons_background_color', get_option('brickyard_social_icons_background_color', '')); 
...
function brickyard_get_top_menu_background_color() {
    $top_menu_background_color = get_theme_mod('brickyard_top_menu_background_color', get_option('brickyard_top_menu_background_color', '')); 
...
function brickyard_get_top_submenu_background_color() {
    $top_submenu_background_color = get_theme_mod('brickyard_top_submenu_background_color', get_option('brickyard_top_submenu_background_color', '')); 
...
function brickyard_get_top_submenu_border_color() {
    $top_submenu_border_color = get_theme_mod('brickyard_top_submenu_border_color', get_option('brickyard_top_submenu_border_color', '')); 
...
function brickyard_get_top_submenu_hover_color() {
    $top_submenu_hover_color = get_theme_mod('brickyard_top_submenu_hover_color', get_option('brickyard_top_submenu_hover_color', '')); 
...
function brickyard_get_main_menu_background_color() {
    $main_menu_background_color = get_theme_mod('brickyard_main_menu_background_color', get_option('brickyard_main_menu_background_color', '')); 
...
function brickyard_get_main_menu_border_color() {
    $main_menu_border_color = get_theme_mod('brickyard_main_menu_border_color', get_option('brickyard_main_menu_border_color', '')); 
...
function brickyard_get_main_menu_links_border_color() {
    $main_menu_links_border_color = get_theme_mod('brickyard_main_menu_links_border_color', get_option('brickyard_main_menu_links_border_color', '')); 
...
function brickyard_get_main_submenu_background_color() {
    $main_submenu_background_color = get_theme_mod('brickyard_main_submenu_background_color', get_option('brickyard_main_submenu_background_color', '')); 
...
function brickyard_get_main_submenu_border_color() {
    $main_submenu_border_color = get_theme_mod('brickyard_main_submenu_border_color', get_option('brickyard_main_submenu_border_color', '')); 
...
function brickyard_get_main_submenu_hover_color() {
    $main_submenu_hover_color = get_theme_mod('brickyard_main_submenu_hover_color', get_option('brickyard_main_submenu_hover_color', '')); 
...
function brickyard_get_header_content_background_color() {
    $header_content_background_color = get_theme_mod('brickyard_header_content_background_color', get_option('brickyard_header_content_background_color', '')); 
...
function brickyard_get_main_content_background_color() {
    $main_content_background_color = get_theme_mod('brickyard_main_content_background_color', get_option('brickyard_main_content_background_color', '')); 
...
function brickyard_get_shadows_color() {
    $shadows_color = get_theme_mod('brickyard_shadows_color', get_option('brickyard_shadows_color', '')); 
...
function brickyard_get_author_comments_background_color() {
    $author_comments_background_color = get_theme_mod('brickyard_author_comments_background_color', get_option('brickyard_author_comments_background_color', '')); 
...
function brickyard_get_sticky_post_background_color() {
    $sticky_post_background_color = get_theme_mod('brickyard_sticky_post_background_color', get_option('brickyard_sticky_post_background_color', '')); 
...
function brickyard_get_posts_thumbnail_background_color() {
    $posts_thumbnail_background_color = get_theme_mod('brickyard_posts_thumbnail_background_color', get_option('brickyard_posts_thumbnail_background_color', '')); 
...
function brickyard_get_highlight_background_color() {
    $highlight_background_color = get_theme_mod('brickyard_highlight_background_color', get_option('brickyard_highlight_background_color', '')); 
...
function brickyard_get_footer_background_color() {
    $footer_background_color = get_theme_mod('brickyard_footer_background_color', get_option('brickyard_footer_background_color', '')); 
...
function brickyard_get_footer_notices_background_color() {
    $footer_notices_background_color = get_theme_mod('brickyard_footer_notices_background_color', get_option('brickyard_footer_notices_background_color', '')); 
...
function brickyard_get_searchform_border_color() {
    $searchform_border_color = get_theme_mod('brickyard_searchform_border_color', get_option('brickyard_searchform_border_color', '')); 
...
function brickyard_get_searchform_button_background_color() {
    $searchform_button_background_color = get_theme_mod('brickyard_searchform_button_background_color', get_option('brickyard_searchform_button_background_color', '')); 
...
function brickyard_get_searchform_button_hover_color() {
    $searchform_button_hover_color = get_theme_mod('brickyard_searchform_button_hover_color', get_option('brickyard_searchform_button_hover_color', '')); 
...
function brickyard_get_form_fields_background_color() {
    $form_fields_background_color = get_theme_mod('brickyard_form_fields_background_color', get_option('brickyard_form_fields_background_color', '')); 
...
function brickyard_get_form_fields_border_color() {
    $form_fields_border_color = get_theme_mod('brickyard_form_fields_border_color', get_option('brickyard_form_fields_border_color', '')); 
...
function brickyard_get_form_buttons_background_color() {
    $form_buttons_background_color = get_theme_mod('brickyard_form_buttons_background_color', get_option('brickyard_form_buttons_background_color', '')); 
...
function brickyard_get_form_buttons_hover_color() {
    $form_buttons_hover_color = get_theme_mod('brickyard_form_buttons_hover_color', get_option('brickyard_form_buttons_hover_color', '')); 
...
function brickyard_get_table_headers_background_color() {
    $table_headers_background_color = get_theme_mod('brickyard_table_headers_background_color', get_option('brickyard_table_headers_background_color', '')); 
...
// Body color
function brickyard_get_body_color() {
    $body_color = get_theme_mod('brickyard_body_color', get_option('brickyard_body_color', '')); 
...
function brickyard_get_body_google_fonts_size() {
    $body_google_fonts_size = get_theme_mod('brickyard_body_google_fonts_size', get_option('brickyard_body_google_fonts_size', '13')); 
...
function brickyard_get_headings_google_fonts_size() {
    $headingfont_size = get_theme_mod('brickyard_headings_google_fonts_size', get_option('brickyard_headings_google_fonts_size', '48')); 
...
function brickyard_get_site_title_color() {
    $site_title_color = get_theme_mod('brickyard_site_title_color', get_option('brickyard_site_title_color', '')); 
...
function brickyard_get_site_title_hover_color() {
    $site_title_hover_color = get_theme_mod('brickyard_site_title_hover_color', get_option('brickyard_site_title_hover_color', '')); 
...
function brickyard_get_site_description_color() {
    $site_description_color = get_theme_mod('brickyard_site_description_color', get_option('brickyard_site_description_color', '')); 
...
function brickyard_get_description_font_size() {
    $descriptionfont_size = get_theme_mod('brickyard_description_google_fonts_size', get_option('brickyard_description_google_fonts_size', '20')); 
...
function brickyard_get_main_headlines_color() {
    $main_headlines_color = get_theme_mod('brickyard_main_headlines_color', get_option('brickyard_main_headlines_color', '')); 
...
function brickyard_get_headlines_color() {
    $headlines_color = get_theme_mod('brickyard_headlines_color', get_option('brickyard_headlines_color', '')); 
...
function brickyard_get_headline_h1_size() {
    $headline_h1_size = get_theme_mod('brickyard_headline_h1_size', get_option('brickyard_headline_h1_size', '27')); 
...
function brickyard_get_headline_h2_size() {
    $headline_h2_size = get_theme_mod('brickyard_headline_h2_size', get_option('brickyard_headline_h2_size', '21')); 
...
function brickyard_get_headline_h3_size() {
    $headline_h3_size = get_theme_mod('brickyard_headline_h3_size', get_option('brickyard_headline_h3_size', '18')); 
...
function brickyard_get_headline_h4_size() {
    $headline_h4_size = get_theme_mod('brickyard_headline_h4_size', get_option('brickyard_headline_h4_size', '16')); 
...
function brickyard_get_headline_h5_size() {
    $headline_h5_size = get_theme_mod('brickyard_headline_h5_size', get_option('brickyard_headline_h5_size', '14')); 
...
function brickyard_get_headline_h6_size() {
    $headline_h6_size = get_theme_mod('brickyard_headline_h6_size', get_option('brickyard_headline_h6_size', '13')); 
...
function brickyard_get_headline_box_google_fonts() {
    $headline_box_google_fonts = get_theme_mod('brickyard_headline_box_google_fonts', get_option('brickyard_headline_box_google_fonts', 'default')); 
...
function brickyard_get_homepage_headlines_color() {
    $homepage_headlines_color = get_theme_mod('brickyard_homepage_headlines_color', get_option('brickyard_homepage_headlines_color', '')); 
...
function brickyard_get_headline_box_google_fonts_size() {
    $headline_box_google_fonts_size = get_theme_mod('brickyard_headline_box_google_fonts_size', get_option('brickyard_headline_box_google_fonts_size', '27')); 
...
function brickyard_get_postentry_font_size() {
    $postentryfont_size = get_theme_mod('brickyard_postentry_google_fonts_size', get_option('brickyard_postentry_google_fonts_size', '21')); 
...
function brickyard_get_postentry_color() {
    $post_entry_color = get_theme_mod('brickyard_post_entry_color', get_option('brickyard_post_entry_color', '')); 
...
function brickyard_get_postentry_hover_color() {
    $post_entry_hover_color = get_theme_mod('brickyard_post_entry_hover_color', get_option('brickyard_post_entry_hover_color', '')); 
...
function brickyard_get_sidebar_widget_font() {
    $sidebarfont = get_theme_mod('brickyard_sidebar_google_fonts', get_option('brickyard_sidebar_google_fonts', 'default')); 
    if ($sidebarfont != 'default' && $sidebarfont != '') { ?>
    <?php _e('#wrapper #container #sidebar .sidebar-widget .sidebar-headline, #wrapper .brickyard_widget_content .tab_title a, #wrapper #wrapper-footer #footer .footer-widget .footer-headline { font-family: "'); ?><?php echo $sidebarfont ?><?php _e('", Arial, Helvetica, sans-serif; }'); ?>
<?php } 
}

// Sidebar widget headlines color
function brickyard_get_sidebar_widget_color() {
    $sidebar_widget_color = get_theme_mod('brickyard_sidebar_widget_color', get_option('brickyard_sidebar_widget_color', '')); 
		if ($sidebar_widget_color != '#' && $sidebar_widget_color != '') { ?>
		<?php _e('#wrapper #container #sidebar .sidebar-widget .sidebar-headline, #wrapper .brickyard_widget_content .tab_title a { color: '); ?><?php echo $sidebar_widget_color ?><?php _e('; }'); ?>
<?php } 
}

// Sidebar widget headlines font size
function brickyard_get_sidebar_widget_font_size() {
    $sidebarfont_size = get_theme_mod('brickyard_sidebar_google_fonts_size', get_option('brickyard_sidebar_google_fonts_size', '19')); 
...
function brickyard_get_sidebar_text_color() {
    $sidebar_text_color = get_theme_mod('brickyard_sidebar_text_color', get_option('brickyard_sidebar_text_color', '')); 
...
function brickyard_get_footer_widget_color() {
    $footer_widget_color = get_theme_mod('brickyard_footer_widget_color', get_option('brickyard_footer_widget_color', '')); 
...
function brickyard_get_footer_widget_font_size() {
    $footerfont_size = get_theme_mod('brickyard_footer_google_fonts_size', get_option('brickyard_footer_google_fonts_size', '19')); 
...
function brickyard_get_footer_text_color() {
    $footer_text_color = get_theme_mod('brickyard_footer_text_color', get_option('brickyard_footer_text_color', '')); 
...
function brickyard_get_footer_notices_text_color() {
    $footer_notices_text_color = get_theme_mod('brickyard_footer_notices_text_color', get_option('brickyard_footer_notices_text_color', '')); 
...
function brickyard_get_content_links_color() {
    $content_links_color = get_theme_mod('brickyard_content_links_color', get_option('brickyard_content_links_color', '')); 
...
function brickyard_get_sidebar_links_color() {
    $sidebar_links_color = get_theme_mod('brickyard_sidebar_links_color', get_option('brickyard_sidebar_links_color', '')); 
...
function brickyard_get_footer_links_color() {
    $footer_links_color = get_theme_mod('brickyard_footer_links_color', get_option('brickyard_footer_links_color', '')); 
...
function brickyard_get_footer_notices_links_color() {
    $footer_notices_links_color = get_theme_mod('brickyard_footer_notices_links_color', get_option('brickyard_footer_notices_links_color', '')); 
...
function brickyard_get_main_header_menu_color() {
    $main_header_menu_color = get_theme_mod('brickyard_main_header_menu_color', get_option('brickyard_main_header_menu_color', '')); 
...
function brickyard_get_main_header_menu_hover_color() {
    $main_header_menu_hover_color = get_theme_mod('brickyard_main_header_menu_hover_color', get_option('brickyard_main_header_menu_hover_color', '')); 
...
function brickyard_get_main_header_menu_hover_background_color() {
    $main_header_menu_hover_background_color = get_theme_mod('brickyard_main_header_menu_hover_background_color', get_option('brickyard_main_header_menu_hover_background_color', '')); 
...
function brickyard_get_active_main_header_menu_color() {
    $active_main_header_menu_color = get_theme_mod('brickyard_active_main_header_menu_color', get_option('brickyard_active_main_header_menu_color', ''));
...
function brickyard_get_active_main_header_menu_background_color() {
    $active_main_header_menu_background_color = get_theme_mod('brickyard_active_main_header_menu_background_color', get_option('brickyard_active_main_header_menu_background_color', ''));
...
function brickyard_get_top_header_menu_color() {
    $top_header_menu_color = get_theme_mod('brickyard_top_header_menu_color', get_option('brickyard_top_header_menu_color', '')); 
...
function brickyard_get_top_header_menu_hover_color() {
    $top_header_menu_hover_color = get_theme_mod('brickyard_top_header_menu_hover_color', get_option('brickyard_top_header_menu_hover_color', '')); 
...
function brickyard_get_top_header_menu_hover_background_color() {
    $top_header_menu_hover_background_color = get_theme_mod('brickyard_top_header_menu_hover_background_color', get_option('brickyard_top_header_menu_hover_background_color', '')); 
...
function brickyard_get_active_top_header_menu_color() {
    $active_top_header_menu_color = get_theme_mod('brickyard_active_top_header_menu_color', get_option('brickyard_active_top_header_menu_color', ''));
...
function brickyard_get_top_submenu_text_color() {
    $top_submenu_text_color = get_theme_mod('brickyard_top_submenu_text_color', get_option('brickyard_top_submenu_text_color', '')); 
...
function brickyard_get_menu_font_size() {
    $menufont_size = get_theme_mod('brickyard_menu_google_fonts_size', get_option('brickyard_menu_google_fonts_size', '14')); 
...
function brickyard_get_top_menu_font_size() {
    $top_menufont_size = get_theme_mod('brickyard_top_menu_google_fonts_size', get_option('brickyard_top_menu_google_fonts_size', '13')); 
