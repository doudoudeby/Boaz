...
<div id="comments" class="comments-area<?php if ( $happenstance_next_preview_post == 'Display' && $happenstance_display_related_posts == 'Hide' && $happenstance_display_related_posts != '' ) { ?> comments-area-post<?php } ?><?php if ( $happenstance_next_preview_post == 'Hide' && $happenstance_share_buttons_post == 'Hide' ) { ?> comments-area-post-hide<?php } ?><?php if ( $happenstance_share_buttons_page == 'Hide' ) { ?> comments-area-page-hide<?php } ?>">
