...
class happenstance_Wp_Plugins_v301 {
	 ...
	 *
	 * @return happenstance_Wp_Plugins
	 */
	public function __construct( $args = array() ) {
		...
		load_plugin_textdomain( 'happenstance-wp', false, $this->textdomain . '/lang' );
	...
	public function parent_plugins_loaded() {
		...
		if ( ! has_action( 'happenstance_side_info_column' ) ) {
			$this->hook( 'happenstance_side_info_column', 'feed_box'      );
		}
	}
...
} // End of class happenstance_Wp_Plugins
