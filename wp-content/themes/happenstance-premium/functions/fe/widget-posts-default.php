<?php
/**
 * Plugin Name: HappenStance Posts-Default Widget
 * Description: Displays the latest posts from the selected category in the default manner.
 * Author: Tomas Toman	
 * Version: 1.0
*/

add_action('widgets_init', create_function('', 'return register_widget("happenstance_homepage_default");'));
class happenstance_homepage_default extends WP_Widget {
	function __construct() {
		$widget_ops = array('classname' => 'homepage-default-posts', 'description' => __('Displays the latest posts from the selected category in the default manner.', 'happenstance') );
		$control_ops = array('width' => 200, 'height' => 400);
		parent::__construct('happenstancedefault', __('HappenStance Posts-Default', 'happenstance'), $widget_ops, $control_ops);
	}
